...
TEST_CASES = [
    ...
    pytest.param((1, 1), 1, id="My example 1"),
    pytest.param((2, 1), 1, id="My example 2"),
    pytest.param((1, 2), 1, id="My example 3"),
    pytest.param((2, 2), 2, id="My example 4"),
    pytest.param((2, 3), 3, id="My example 5"),
    pytest.param((3, 2), 3, id="My example 6"),
    pytest.param((3, 3), 6, id="My example 7"),
]
...
@pytest.mark.parametrize(["incoming_dimensions", "expected_outcome"], TEST_CASES)
def test_cycle(incoming_dimensions: tuple[int], expected_outcome):
    from problems.p62_unique_paths.cycle_solution import Solution
    m, n = incoming_dimensions[0], incoming_dimensions[1]
