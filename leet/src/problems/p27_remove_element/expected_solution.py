...
class Solution:
    def removeElement(self, nums: List[int], val: int) -> int:
        ...
        External:leetcode:p27_remove_element: solution resetleetcode:p27_remove_element: solution resetleetcode:p27_remove_element: solution resetleetcode:p27_remove_element: solution resetl
